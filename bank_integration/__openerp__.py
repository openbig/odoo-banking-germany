...
##############################################################################
{
    ...
    'version': '1.13 (7.0)',
    'license': 'GPL-3',
    'author': 'Tadeusz Karpiński, Grzegorz Grzelak OpenGLOBE (based on EduSense and Therp)',
