/**********************************************************************
 * $Source: /cvsroot/jameica/jameica.scripting/src/de/willuhn/jameica/scripting/ext/jameica/SettingsView.java,v $
 * $Revision: 1.4 $
 * $Date: 2010/07/25 23:14:12 $
 * $Author: willuhn $
 * $Locker:  $
 * $State: Exp $
 *
...
package de.willuhn.jameica.scripting.ext.jameica;
...
public class SettingsView implements Extension
{
  ...
  public void extend(Extendable extendable)
  {
    ...
    mf.getMessagingQueue(de.willuhn.jameica.scripting.Settings.QUEUE_ADDED).registerMessageConsumer(this.mcAdded);
    mf.getMessagingQueue(de.willuhn.jameica.scripting.Settings.QUEUE_REMOVED).registerMessageConsumer(this.mcRemoved);
    ...
    try
    {
      ...
      tab.getComposite().addDisposeListener(new DisposeListener() {
        ...
        public void widgetDisposed(DisposeEvent e)
        {
          ...
          mf.getMessagingQueue(de.willuhn.jameica.scripting.Settings.QUEUE_ADDED).unRegisterMessageConsumer(mcAdded);
          mf.getMessagingQueue(de.willuhn.jameica.scripting.Settings.QUEUE_REMOVED).unRegisterMessageConsumer(mcRemoved);
        }
  ...
  private void handleStore() throws ApplicationException
  {
    try
    {
      de.willuhn.jameica.scripting.Settings.reload();
    }
    catch (Exception e)
    {
  ...
  private TablePart getScripts() throws RemoteException
  {
    ...
    this.scripts = new TablePart(de.willuhn.jameica.scripting.Settings.getScripts(),null);
  ...
  private class ActionAdd implements Action
  {
    ...
    public void handleAction(Object context) throws ApplicationException
    {
      ...
      de.willuhn.jameica.scripting.Settings.addScript(file);
    }
  }
  ...
  private class ActionRemove implements Action
  {
    ...
    public void handleAction(Object context) throws ApplicationException
    {
      ...
      try
      {
        ...
        de.willuhn.jameica.scripting.Settings.removeScript((File)context);
      }
